...
- [x] **Redesign Compacto do App Desktop (520x700):** Redução da largura para janela estreita e alinhamento 100% vertical de todos os botões de ação.
- [x] **Organização em 3 Abas (Aba 1: STATUS):** Componente `StatusTab` exibindo o estado em tempo real do Monitoramento de Pastas, Painel Web (FastAPI) e IA Local (Ollama) como a primeira aba ativa ao iniciar o aplicativo.
