...
- [x] **Transcrição Literal com Realce de Entidades & Formulários de Especialidade (7 Tipos):** Detalhamento completo no ADR-097 (`.ai_context/03_decisions_and_workflow.md`).
...
- [ ] **Task 1.5 — Eliminação Total do Pass 1 Legado, Quebrado em Passes Dedicados (PRÓXIMA ETAPA):**
  - Plano completo em [`proposta_eliminacao_pass1_legado.md`](./proposta_eliminacao_pass1_legado.md) e ADR-096 (`03_decisions_and_workflow.md`).
