...
class SqliteRepo(IDatabaseRepo):
    ...
    def _build_report_from_row(self, conn: sqlite3.Connection, relint_row: sqlite3.Row) -> IncidentReport:
        ...
        if bm_group == "Roubo a Estabelecimento":
            ...
            from src.dashboard.backend.core.entities import EstablishmentRobberyReport
        ...
        if bm_group == "Roubo a Residência":
            ...
            from src.dashboard.backend.core.entities import ResidenceRobberyReport
        ...
        if bm_group == "Roubo a Pedestre":
            ...
            from src.dashboard.backend.core.entities import PedestrianRobberyReport
        ...
        if bm_group == "Furto de Veículo":
            ...
            from src.dashboard.backend.core.entities import VehicleTheftReport
