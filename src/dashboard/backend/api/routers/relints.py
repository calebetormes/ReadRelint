...
from src.dashboard.backend.api.dependencies import get_db_repo, get_person_repo
from src.dashboard.backend.api.schemas.relints import (
...
def get_relint_by_id(
    ...
    from src.dashboard.backend.core.geo_service import extract_structured_address, resolve_report_map_info
    ...
    from src.dashboard.backend.core.entities import HomicideReport, DrugTraffickingReport, EstablishmentRobberyReport, ResidenceRobberyReport, VehicleRobberyReport, PedestrianRobberyReport, VehicleTheftReport
...
def update_relint(
    ...
    from src.dashboard.backend.core.entities import IncidentReport, HomicideReport, Participant
...
# ─────────────────────────────────────────────────────────────────────────────
from src.dashboard.backend.api.routers.participants import list_participants as _list_p, get_participant_dossier as _get_p_dossier, PersonDossierDTO
