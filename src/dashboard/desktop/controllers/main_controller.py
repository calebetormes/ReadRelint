...
from src.task_manager.watcher.folder_watcher import FolderWatcher
from src.task_manager.etl.etl_service import EtlService
from src.engine.rules.relint_rule import RelintRule
from src.task_manager.registry.json_processed_registry import JsonProcessedRegistry
from src.dashboard.desktop.controllers.web_app_manager import WebAppManager
...
class MainController:
    ...
    def __init__(self):
        ...
        from src.dashboard.backend.api.dependencies import set_main_controller
