...
from src.dashboard.desktop.utils.module_loader import ModuleLoader
...
def main():
    ...
    (Controllers, Views, Components) dentro da pasta 'src.dashboard.desktop'
    ...
    try:
        ...
        ModuleLoader.load_modules_from_directory(base_dir=desktop_dir, package_prefix="src.dashboard.desktop")
